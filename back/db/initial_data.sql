...
INSERT INTO Parada (idViaje, numParada, idEstacion, fechaEstimadaLlegada) VALUES
	(1, 1, 2, 20240604060000),
    (1, 2, 24, 20240604090000),
    (1, 3, 8, 20240604120000),
    (1, 4, 13, 20240605050000),
	(1, 5, 12, 20240605100000),
	(1, 6, 20, 20240605180000);

INSERT INTO Parada (idViaje, numParada, idEstacion, fechaEstimadaLlegada) VALUES
	(2, 1, 8, 20240604080000),
    (2, 2, 12, 20240604100000),
    (2, 3, 23, 20240604110000),
    (2, 4, 24, 20240604130000),
	(2, 5, 28, 20240604150000),
	(2, 6, 13, 20240605100000),
	(2, 7, 2, 20240605180000);
    
INSERT INTO Parada (idViaje, numParada, idEstacion, fechaEstimadaLlegada) VALUES
	(3, 1, 32, 20240604150000),
    (3, 2, 31, 20240604190000),
    (3, 3, 19, 20240604230000),
    (3, 4, 24, 20240605060000),
	(3, 5, 1, 20240605100000),
	(3, 6, 18, 20240605180000),
	(3, 7, 13, 20240605230000);